...
# %%
chart3 = df.groupby('sname')['list_name'].count().reset_index().sort_values('list_na me',ascending=False).head(10)
x = range(len(chart3))
plt.figure(figsize=(14,8))
plt.title('歌单收录歌曲 TOP10') plt.barh(x,chart3['list_name'],color='dodgerblue') plt.yticks(x,chart3['sname'])
plt.show()