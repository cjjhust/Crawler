...
#%%
cates = df.sort_values('收藏次数',ascending=False).drop_duplicates('list_name') 
cates.groupby('list_tage')['list_name'].count().reset_index().sort_values('list_nam e',ascending=False)