...
cates.groupby('list_tage')['listname'].count().reset_index().sort_values('listname',ascending=False)

# %%
chart4 = cates.groupby('list_tage')['list_name'].count().reset_index().sort_values(' list_name',ascending=False)
plt.figure(figsize=(10,10))
x_list = chart4['list_name']
label_list = chart4['list_tage'] plt.pie(x_list,labels=label_list,autopct="%1.f%%") plt.title('百度歌单分类占比')
plt.show()
